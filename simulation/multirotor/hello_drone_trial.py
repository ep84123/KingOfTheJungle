...
def fly_to(client,yaw,pitch,angle_sum):
    ...
    client.moveByVelocityBodyFrameAsync(vx, vy, vz, duration, drivetrain=0, yaw_mode=airsim.YawMode(is_rate=False, yaw_or_rate=angle_sum))
